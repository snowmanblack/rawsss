...
set useragent "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 Chrome/79.0.3945.74 Safari/537.36 Edg/79.0.309.43";
...
http-get {
    ...
    client {
        ...
        header "Host" "offlce365.network.global.prod.fastly.net";
        ...
        #header "MicrosoftApplicationsTelemetryDeviceId" "8e64u2iw-9z61GDwq-6s-iFIRr64-n6j0s9-c24B;";
